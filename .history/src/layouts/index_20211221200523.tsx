 ...
 * @LastEditors: 赵卓轩
 * @LastEditTime: 2021-12-21 20:04:34
 */
  ...
  return (
    <Layout>
      <Header style={{ position: 'fixed', zIndex: 999, width: '100%', backgroundColor: 'white' }}>
        ...
        <Search placeholder="input search text" onSearch={onSearch} enterButton style={{width: 200, position: 'absolute', right: '400px', top: '50px'}}/>
        <Link to="/chat">

 ...
 * @LastEditors: 赵卓轩
 * @LastEditTime: 2021-10-27 17:30:07
 */
  ...
  return (
    <Layout>
      <Header style={{ position: 'fixed', zIndex: 999, width: '100%' }}>
        <div style={{ float: 'left', color: 'white', fontSize: '1.5rem', marginRight: '50px' }}>
        ...
        <Menu theme="dark" mode="horizontal" defaultSelectedKeys={['frontpage-menu']} onClick={handleClick}>
          ...
          <Menu.Item key="animals-menu" icon={<RobotOutlined />}>动物一览</Menu.Item>
          <Menu.Item key="info-menu" icon={<ContainerOutlined />}>信息门户</Menu.Item>
          <Menu.Item key="smart-menu" icon={<LineChartOutlined />}>智能管理</Menu.Item>
        </Menu>
        <Link to="/chat">

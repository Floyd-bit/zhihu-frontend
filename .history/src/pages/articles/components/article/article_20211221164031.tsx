 ...
 * @LastEditors: 赵卓轩
 * @LastEditTime: 2021-12-21 16:39:41
 */
    ...
    return (
        <div className={style.container}>
            ...
            <div className={style.footer} style={{display: props.showBtn ? 'flex' : 'none'}}>
                <Button style={{backgroundColor: '#E5EFFF', color:'#0066FF'}}><CaretUpOutlined />
                    <span>赞同</span>
                    <span style={{display: 'inline-block', marginLeft: '0.1em'}}>{props.star}</span>
                </Button>
